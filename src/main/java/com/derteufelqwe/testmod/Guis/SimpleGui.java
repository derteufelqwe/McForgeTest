...
public class SimpleGui extends GuiScreen {
    ...
    public SimpleGui() {
        ...
        bookPageTextures[0] = new ResourceLocation(TestMod.MODID+":textures/gui/book_cover.png");
        bookPageTextures[1] = new ResourceLocation(TestMod.MODID+":textures/gui/book.png");
        bookPageTextures[2] = new ResourceLocation(TestMod.MODID+":textures/gui/book.png");

        stringPageText[0] = "";

        stringPageText[1] = "The Mysterious Stranger admired your family cow and asked if it was for sale.\n\nWhen you " +
                "nodded, he offered to trade some Magic Beans, that (if planted in tilled dirt) would lead to more " +
                "wealth than you could imagine.";

        stringPageText[2]="So you handed him your cow, and grabbed the Magic Beans.\n\nPleased with yourself, you " +
                "hurried away, looking for tilled dirt in which to plant the Magic Beans.\n\nYou couldn't wait to " +
                "see how proud your mother would be for";
        stringPageText[3]="being so shrewd!  Untold wealth in return for an old, milkless cow; what a good deal you " +
